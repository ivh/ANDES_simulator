...
zmx = InteractiveZEMAX(name='ANDES123', zemax_filepath="HIRES_Y_21jan2022_sconf_noap.zmx")
...
for i in range(nfiber):
    ...
    zmx.set_orders(1, i+1, list(range(109, 127)))    
...
hdf_path = project_root / 'HDF' / 'ANDES_75fibre_Y.hdf'
